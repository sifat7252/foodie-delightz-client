        ...
        <div>
          ...
          <hr />
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 w-auto mx-auto gap-2 p-4">
                <div >
                   <div className="card h-60 lg:h-96 mt-2   lg:mb-6 p-4 text-center items-center bg-cyan-100 justify-center shadow-xl " data-aos="fade-up-right">
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-2   mb-6 p-4 text-center items-center bg-rose-200 justify-center shadow-xl  " data-aos="zoom-in-up"
     >
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-2   mb-6 p-4 text-center items-center  bg-blue-200 justify-center shadow-xl " data-aos="zoom-in-up">
                ...
                <div >
                   <div className="card h-80 lg:h-96 mt-2   mb-6 p-4 text-center items-center bg-fuchsia-300  justify-center shadow-xl " data-aos="fade-up-right">
